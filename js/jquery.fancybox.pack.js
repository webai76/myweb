    ...
    f.extend(b, {
        ...
        defaults: {
            ...
            tpl: {
                ...
                closeBtn: '<a title="Close" class="fancybox-item fancybox-close" href="javascript:;"><i class="glyphicon glyphicon-remove"></i></a>',
                next: '<a title="Next" class="fancybox-nav fancybox-next" href="javascript:;"><span><i class="glyphicon glyphicon-menu-right"></i></span></a>',
                prev: '<a title="Previous" class="fancybox-nav fancybox-prev" href="javascript:;"><span><i class="glyphicon glyphicon-menu-left"></i></span></a>'
            },
            openEffect: "fade",
            openSpeed: 250,
            openEasing: "swing",
